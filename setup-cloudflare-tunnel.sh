...
echo "     - hostname: admin.hellocolello.com"
echo "       service: http://localhost:41114"
echo "     # Minecraft Bedrock Server (UDP + TCP)"
echo "     - hostname: play.hellocolello.com"
echo "       service: tcp://192.168.86.149:19132"
echo "     # Catch-all"
echo "     - service: http_status:404"
echo ""
echo "4. Route your domains:"
echo "   cloudflared tunnel route dns pickaxe-rcon admin.hellocolello.com"
echo "   cloudflared tunnel route dns pickaxe-rcon play.hellocolello.com"
echo ""
